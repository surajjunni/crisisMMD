...
if __name__ == "__main__":
    ...
    parser.add_option("--lambda", action="store", dest="lam", default=0.5, type="float")
    ...
    text_network=options.lam*text_network
    #print(text_network) 
    ######## Image text_network ########
    ...
    last_layer_output=(1-options.lam)*last_layer_output
    #print(last_layer_output)
    ######## Merge image and text networks ########
    
    merged_network = keras.layers.Add()([text_network,last_layer_output])
